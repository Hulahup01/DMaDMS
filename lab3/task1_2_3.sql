...
IS 
    ...
    is_exists BOOLEAN;
BEGIN
    EXECUTE IMMEDIATE 'TRUNCATE TABLE DIFF_TABLES';
    EXECUTE IMMEDIATE 'TRUNCATE TABLE OUT_TABLES';
    dbms_output.put_line(' ');
    dbms_output.put_line('======================-[INFO]-=====================');
    dbms_output.put_line('----------------[Tables Differences]---------------');
    dbms_output.put_line(' ');
    ...
    dbms_output.put_line(' ');
    dbms_output.put_line('--------------[Procedures Differences]-------------');
    dbms_output.put_line(' ');
    ...
    dbms_output.put_line(' ');
    dbms_output.put_line('--------------[Functions  Differences]-------------');
    dbms_output.put_line(' ');
    ...
    dbms_output.put_line(' ');
    dbms_output.put_line('---------------[Indexes  Differences]--------------');
    dbms_output.put_line(' ');
    ...
    COMPARE_SCHEMAS_DDL(dev_schema_name, prod_schema_name);
